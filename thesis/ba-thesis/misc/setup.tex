...
\setmonofont[
	Path           = fonts/,
		BoldFont       = {Fira-Code-Bold-Nerd-Font-Complete-Mono.otf},
...
\usepackage{expex}  % for linguistic examples, brackets and glosses
\usepackage{xcolor}
\usepackage[linesnumbered,ruled,vlined]{algorithm2e}  % for typesetting algorithms
\usepackage{multirow}
...
\usepackage[
	...
	style=apa,
	maxcitenames=1,
	maxbibnames=3, % when does the citation change to et al?
	minnames=1,
	uniquelist=false,
	uniquename=false,
