...
% 	well[\textlf{1}|\textlf{0}|BEG]
% 	‡[\textlf{2}|\textlf{1}|BEGP]
% 	that[\textlf{3}|\textlf{4}|SUBJ]
% 	's[\textlf{4}|\textlf{0}|ROOT]
% 	life[\textlf{5}|\textlf{4}|OBJ]
% 	.[\textlf{6}|\textlf{4}|PUNCT]
% \glft ‘Well, that's life.’
% \endgl
% \xe
% \ex
% \begingl[glstyle=nlevel]
% 	son[\textlf{1}|\textlf{0}|BEG]
% 	‡[\textlf{2}|\textlf{1}|BEGP]
% 	that[\textlf{3}|\textlf{4}|SUBJ]
% 	's[\textlf{4}|\textlf{0}|ROOT]
% 	life[\textlf{5}|\textlf{4}|OBJ]
% 	.[\textlf{6}|\textlf{4}|PUNCT]
% \glft ‘Son, that's life.’
% \endgl
% \xe
% \ex
% \begingl[glstyle=nlevel]
% 	that[\textlf{1}|\textlf{2}|SUBJ]
% 	's[\textlf{2}|\textlf{0}|ROOT]
% 	life[\textlf{3}|\textlf{2}|OBJ]
% 	„[\textlf{4}|\textlf{5}|ENDP]
% 	right[\textlf{5}|\textlf{2}|END]
% 	?[\textlf{6}|\textlf{2}|PUNCT]
% \glft ‘That's life, right?’
% \endgl
% \xe
% \end{minipage}
...
\pex~ Sentences with non-final punctuations\deftagex{multiple root}
\a {[\sl Well\/}]$_{\text{\sc intj}}$, that's life.        \hfill {\sl interjection}
\a {[\sl  Son\/}]$_{\text{\sc voc}}$, that's life.         \hfill {\sl vocative}
\a That's life , {[\sl isn't it}]$_{\text{\sc tag}}$?    \hfill {\sl tag question}
\xe
...
\end{dependency}
\end{minipage}
\captionof{figure}{CHILDES vs UD dependency graphs: interjections}
...
\end{dependency}
\end{minipage}
\captionof{figure}{CHILDES vs UD dependency graphs: vocatives}


% \begin{minipage}{\widefigurewidth}
\begin{minipage}{\widefigurewidth}\label{fig:taggr}
\begin{dependency}[edge slant=3pt]
...
\begin{minipage}{\linewidth}\label{fig:tagdeprel}
