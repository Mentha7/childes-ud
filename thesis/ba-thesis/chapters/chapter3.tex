...
The challenge of nested angle brackets can be illustrated using two example utterances:\sidenote{These examples are taken from the CHILDES databse of the Brown Corpus (\cite{brown1973}). }\\
\vspace{-1em}
\lstset{
numbers = none,
frame = single,
